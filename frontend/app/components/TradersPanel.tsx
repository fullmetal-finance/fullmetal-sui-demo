...
import { MOCK_TRADERS, type MockTrader } from "@/lib/mock";
import ManageModal from "./ManageModal";

export default function TradersPanel() {
  const [selected, setSelected] = useState<MockTrader | null>(null);
  return (
    <>
          ...
          {MOCK_TRADERS.map((t) => {
            ...
            return (
              <div
                ...
                className="flex cursor-pointer items-center gap-4 px-6 py-4 transition-colors hover:bg-[rgba(0,0,0,0.05)]"
              >
      ...
      <ManageModal
        subject={selected ? { kind: "trader", trader: selected } : null}
